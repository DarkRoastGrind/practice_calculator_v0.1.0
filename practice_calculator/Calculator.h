...
namespace practicecalculator {
	...
	public ref class Calculator : public System::Windows::Forms::Form
	{
		...
		// -------------------- Designer Variable --------------------
		#pragma region Designer Variable
			private:
				/// <summary>
		...
		// -------------------- Declarations for buttons/labels/text boxes. --------------------
		...
		// -------------------- Boolean Functions/Input Checking --------------------
		#pragma region Boolean functions for input checking
		...
		// -------------------- Clear fields buttons and functions --------------------
		#pragma region Clear Fields Button functions
			// Clear input button
		...
		#pragma region Number button functions
